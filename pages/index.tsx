...
const Home: NextPage = () => {
  return (
    <div className='container mx-auto'>
      ...
      <div className='flex flex-col items-center mx-auto md:flex-row md:justify-between md:items-start gap-10 pb-12'>
        <div className='w-4/5 lg:w-1/4 block'>
          <Image 
            ...
            <Divider style='SMALL'/>
            <p className='text-center max-w-prose text-lg font-yadon-bold'>
      ...
      <div>
        <h1 className='text-center px-4 text-6xl font-chic pt-8 text-gray-700 font-[1000]'>Featured Homes</h1>
        <Divider style='LARGE'/>
      </div>
